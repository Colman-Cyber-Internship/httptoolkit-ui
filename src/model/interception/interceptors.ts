...
const INTERCEPT_OPTIONS: _.Dictionary<InterceptorConfig> = {
  ...
  "fresh-terminal": {
    name: "Fresh Terminal",
    description: [
      "Open a new terminal that intercepts all processes & Docker containers",
    ],
  ...
  "existing-terminal": {
    ...
    description: [
      "Intercept all launched processes & Docker containers from an existing terminal window",
    ],
  ...
  "android-adb": {
    ...
    notAvailableHelpUrl:
      "https://httptoolkit.com/docs/guides/android/#android-device-via-adb-interception-option-is-not-available",
  ...
  "ios-device": {
    name: "An iOS device",
    description: [
      "Intercept all HTTP traffic from an iOS device on your network",
    ],
  ...
  "network-device": {
    ...
    description: [
      "Intercept all HTTP traffic from another device on your network",
    ],
  ...
  [MANUAL_INTERCEPT_ID]: {
    name: "Anything",
    description: [
      "Manually configure any source using the proxy settings and CA certificate",
    ],
